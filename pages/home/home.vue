			...
			<view v-if="current===0" class="article-list">
				<view class="article-list-card">
					<view class="article-list-card-head">
						...
						<view>
							<view style="color: #FC965E; font-weight: bold;margin-bottom: 10rpx;">表白墙</view>
							<!-- 发布者 -->
							<view style="font-size: 20rpx;color: #999999;"> <uni-dateformat :date="Date.now()"
					...
					<view class="article-list-card-data">
						...
						<view class="article-list-card-data-right">
							...
							<view style="margin-right: 20rpx;font-size: 22rpx;">40</view>
							...
							<view style="font-size: 22rpx;">49</view>
						</view>
					</view>
				</view>
			</view>
