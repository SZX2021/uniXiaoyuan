        ...
        <view class="article-list-card" v-for="(item, index2) in article" :key="index2">
          <view class="article-list-card-head">
            <view style="margin-right: 20rpx;">
              <!--  <image src="../../static/home/avatar.jpg" style="border-radius: 50%;width: 80rpx;height: 80rpx;"></image> -->
            </view>
            <!-- 头像组件无法修改样式，在组件外加一个view用来调整外边距 -->
            <view>
              <view style="color: #FC965E; font-weight: bold;margin-bottom: 10rpx;">{{item.author_info.user_name}}
              </view>
              <!-- 发布者 -->
